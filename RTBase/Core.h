...
public:
	...
	float dot1(const Vec3& other) const {
...
public:
	...
	Vec4 operator*(const Vec4& v) const {
		return Vec4(
			m[0] * v.x + m[1] * v.y + m[2] * v.z + m[3] * v.w,   // x
			m[4] * v.x + m[5] * v.y + m[6] * v.z + m[7] * v.w,   // y
			m[8] * v.x + m[9] * v.y + m[10] * v.z + m[11] * v.w, // z
			m[12] * v.x + m[13] * v.y + m[14] * v.z + m[15] * v.w // w
		);
	}
};
